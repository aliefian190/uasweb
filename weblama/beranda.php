...
<form action="index.php" method="POST">
    <div class="d-flex">
        <input class="form-control mx-sm-2 my-2 w-auto" type="text" name="pelanggan" placeholder="Nama Pelanggan"
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isset($_SESSION["akun-admin"])) { ?>
                            <p>
                                ...
                                <a class="btn btn-lg btn-danger" title="Hapus" href="hapus.php?id_menu=<?= $m["id_menu"]; ?>"
